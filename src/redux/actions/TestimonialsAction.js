...
export const  TestimonialsActions = {
    GET_TESTIMONIALS_ACTIONS_SUCCESS : "GET_TESTIMONIALS_ACTIONS_SUCCESS" ,
    GET_TESTIMONIALS_ACTIONS_FAILED : "GET_TESTIMONIALS_ACTIONS_FAILED" ,
    FILTER_TESTIMONIALS : "FILTER_TESTIMONIALS" ,
